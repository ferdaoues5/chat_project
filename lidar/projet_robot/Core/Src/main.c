...
//extern uint8_t buffer_lidar[SIZE_BUFFER_LIDAR];
extern SemaphoreHandle_t sem_Lidar_half_cplt;
extern SemaphoreHandle_t sem_Lidar_cplt;

TaskHandle_t xHandleLidar = NULL;
TaskHandle_t xHandleResetLidar = NULL;
int a=0;
